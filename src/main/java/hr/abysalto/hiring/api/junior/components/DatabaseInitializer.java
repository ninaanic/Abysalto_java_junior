...
public class DatabaseInitializer {
	...
	private void initData() {
		...
		this.jdbcTemplate.execute(
				"INSERT INTO orders (buyer_id, order_status, order_time, payment_option, delivery_address_id, contact_number, currency, total_price) VALUES (2, 'PREPARING', '2026-02-08 08:00:00', 'CASH', 2, '+3859876543', 'EUR', 50.00)");

		this.jdbcTemplate.execute("INSERT INTO item (item_id, name, price) VALUES (1, 'Fresh Salmon Fillet', 10.00)");
		this.jdbcTemplate.execute("INSERT INTO item (item_id, name, price) VALUES (2, 'Avocado Pack', 5.00)");
		this.jdbcTemplate.execute("INSERT INTO item (item_id, name, price) VALUES (3, 'Organic Quinoa 1kg', 10.00)");

		this.jdbcTemplate.execute(
				"INSERT INTO order_item (order_id, item_id, name, quantity, price) VALUES (1, 1, 'Fresh Salmon Fillet', 2, 10.00)");
		this.jdbcTemplate.execute(
				"INSERT INTO order_item (order_id, item_id, name, quantity, price) VALUES (2, 3, 'Organic Quinoa 1kg', 1, 10.00)");

		this.jdbcTemplate.execute(
				"INSERT INTO order_item (order_id, item_id, name, quantity, price) VALUES (2, 2, 'Avocado Pack', 4, 5.00)");

		this.jdbcTemplate.execute(
				"INSERT INTO order_item (order_id, item_id, name, quantity, price) VALUES (2, 1, 'Fresh Salmon Fillet', 2, 10.00)");
